...
if [ $# -lt 2 ]; then
    ...
    echo "    decades: contains comma-separated decade list: eg: 1920,1950,1990 (can be from 1910 to 2020 in 10 increments)"
    echo "    moods: contains comma-separated mood list: eg: SLOW,FAST,WEIRD"
    echo "    countries: contains comma-separated country list: eg: FRA,USA,ITA. (3 letters country identification eg: FRA)"
